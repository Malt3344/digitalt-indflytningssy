          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Kun 149 kr per rapport. Ingen månedlige abonnementer eller skjulte gebyrer.</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Brug din mobil, tablet eller computer. Ingen app-download nødvendig.</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Digitale underskrifter og timestamp. Beskyt dig selv ved tvister.</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Intuitivt flow der guider dig igennem. Ingen læringskurve.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-white">SynsApp</span>
            </div>
            <div className="flex items-center gap-6 text-sm">
              <a href="/privatlivspolitik" className="hover:text-white transition-colors">Privatlivspolitik</a>
              <a href="/vilkaar" className="hover:text-white transition-colors">Handelsbetingelser</a>
              <a href="mailto:support@synsapp.dk" className="hover:text-white transition-colors">Kontakt</a>
            </div>
          </div>
